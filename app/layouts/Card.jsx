...
const Card = ({title,caption,done,bcolor}) => {
  return (
    <div className="flex flex-col gap-y-4 gap lg:w-[339px] md:w-[327px] w-[280px] sm:h-[229px] bg-[#211A75] p-6 rounded-[14px] text-white">
      ...
      <div className="lg:text-[18px] md:text-[16px] sm:text-[14px] text-[13px] font-bold ">
        {title}
      </div>
      ...
      <div className="sm:text-[10px] text-[9px]">
        ...
        <div className="flex font-bold sm:text-[14px] text-[10px] text-[#A5A5A5;]">
          <Image src={Clock} width={16} height={16} alt="Clock" className="object-contain mr-3" />
